<template>
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-title">MASTER FORM</li>
        ...
        <li class="c-sidebar-nav-title">MASTER Forms</li>

        <li class="c-sidebar-nav-item">
            <Link class="c-sidebar-nav-link" href="/apps/master/forms" :class="{ 'active': $page.url.startsWith('/apps/master/forms') }">
            ...
            <span class="ms-2">Master Form</span>
            </Link>
        </li>

        <li class="c-sidebar-nav-title">MASTER Reports</li>

        <li class="c-sidebar-nav-item">
            <Link class="c-sidebar-nav-link" href="/apps/master/reports" :class="{ 'active': $page.url.startsWith('/apps/master/reports') }">
